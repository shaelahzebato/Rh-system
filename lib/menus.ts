export type SubChildren = {
  ...
  export function getMenuList(pathname: string, t: any): Group[] {
    return [
        ...
        menus: [
          {
            ...
            submenus: [
              ...
              },
              {
                ...
                label: "Statistiques",
                active: pathname === "/dashboard/statistique",
              ...
              },
              {
                ...
                label: "Alertes",
                active: pathname === "/dashboard/alertes",
        ...
        menus: [
          {
            ...
            href: "/candidature",
            label: "Candidatures",
            active: pathname.includes("/candidature"),
            ...
            submenus: [
              ...
              {
                href: "/candidature/vivier",
                label: "Vivier de talents",
                active: pathname === "/candidature/vivier",
                icon: "heroicons:user-circle",
                children: [],
              },
              {
                href: "/candidature/entretiens",
                label: "Entretiens",
                active: pathname === "/candidature/entretiens",
                icon: "heroicons:chat-bubble-bottom-center-text",
                children: [],
              },
              {
                href: "/candidature/evaluations",
                label: "Évaluations",
                active: pathname === "/candidature/evaluations",
                icon: "heroicons:academic-cap",
                children: [],
              },
              {
                href: "/candidature/historique",
                label: "Historique des candidats",
                active: pathname === "/candidature/historique",
        ...
        menus: [
          {
            ...
            submenus: [
              {
                href: "/clients/a-valider",
                label: "Clients à valider",
                active: pathname === "/clients/a-valider",
                icon: "heroicons:clipboard-document-check",
                children: [],
              },
              {
                ...
                active: pathname === "/clients/actifs",
                icon: "heroicons:check-badge",
                children: [],
              },
              {
                href: "/clients/interlocuteurs",
                label: "Interlocuteurs",
                active: pathname === "/clients/interlocuteurs",
              ...
              },
              {
                ...
                label: "Documents",
                active: pathname === "/clients/documents",
              ...
              },
              {
                ...
                label: "Historique",
                active: pathname === "/clients/historique",
                icon: "heroicons:clock",
                children: [],
              },
            ],
      ...
      {
        groupLabel: "",
        id: "missions-contrats",
        menus: [
          {
            id: "missions-contrats",
            href: "/missions-contrats",
            label: "Missions & Contrats",
            active: pathname.includes("/missions-contrats"),
            icon: "heroicons-outline:briefcase",
            submenus: [
              {
                href: "/missions-contrats/commandes",
                label: "Commandes à traiter",
                active: pathname === "/missions-contrats/commandes",
                icon: "heroicons:shopping-cart",
                children: [],
              },
              {
                href: "/missions-contrats/en-cours",
                label: "Missions en cours",
                active: pathname === "/missions-contrats/en-cours",
                icon: "heroicons:play",
                children: [],
              },
              {
                href: "/missions-contrats/terminees",
                label: "Missions terminées",
                active: pathname === "/missions-contrats/terminees",
                icon: "heroicons:check-circle",
                children: [],
              },
              {
                href: "/missions-contrats/contrats",
                label: "Génération de contrat",
                active: pathname === "/missions-contrats/contrats",
                icon: "heroicons:document-duplicate",
                children: [],
              },
              {
                href: "/missions-contrats/signatures",
                label: "Signatures en attente",
                active: pathname === "/missions-contrats/signatures",
      ...
      },
      {
        ...
        menus: [
          {
            id: "releves-activite",
            href: "/releves-activite",
            label: "Relevés d'activité",
            active: pathname.includes("/releves-activite"),
            icon: "heroicons-outline:calendar",
            submenus: [
              {
                href: "/releves-activite/a-valider",
                label: "Relevés à valider",
                active: pathname === "/releves-activite/a-valider",
                icon: "heroicons:clipboard-document-check",
                children: [],
              },
              {
                href: "/releves-activite/en-litige",
                label: "Relevés en litige",
                active: pathname === "/releves-activite/en-litige",
                icon: "heroicons:exclamation-circle",
                children: [],
              },
              {
                href: "/releves-activite/historique-validations",
                label: "Historique des validations",
                active: pathname === "/releves-activite/historique-validations",
                icon: "heroicons:document-text",
                children: [],
              },
              {
                href: "/releves-activite/pointeuses-connectees",
                label: "Pointeuses connectées",
                active: pathname === "/releves-activite/pointeuses-connectees",
                icon: "heroicons:device-phone-mobile",
                children: [],
              },
              {
                href: "/releves-activite/rapports",
                label: "Rapports d'activité",
                active: pathname === "/releves-activite/rapports",
                icon: "heroicons:chart-bar",
                children: [],
              },
            ],
      ...
      {
        groupLabel: "",
        id: "demandes-administratives",
        menus: [
          {
            id: "demandes-administratives",
            href: "/demandes-administratives",
            label: "Demandes administratives",
            active: pathname.includes("/demandes-administratives"),
            icon: "heroicons-outline:clipboard-document",
            submenus: [
              {
                href: "/demandes-administratives/conges",
                label: "Congés",
                active: pathname === "/demandes-administratives/conges",
                icon: "heroicons:calendar-days",
                children: [],
              },
              {
                href: "/demandes-administratives/arrets-maladie",
                label: "Arrêts maladie",
                active: pathname === "/demandes-administratives/arrets-maladie",
                icon: "heroicons:heart",
                children: [],
              },
              {
                href: "/demandes-administratives/incidents-travail",
                label: "Incidents de travail",
                active: pathname === "/demandes-administratives/incidents-travail",
                icon: "heroicons:exclamation-triangle",
                children: [],
              },
              {
                href: "/demandes-administratives/autres-demandes",
                label: "Autres demandes",
                active: pathname === "/demandes-administratives/autres-demandes",
...
// Version horizontale adaptée
export function getHorizontalMenuList(pathname: string, t: any): Menu[] {
    const verticalMenu = getMenuList(pathname, t);
    
    // Flatten groups and return only the menus
    return verticalMenu.flatMap(group => 
